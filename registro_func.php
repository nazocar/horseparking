...
<body style="background-color: #EDEDED">
    ...
    <div class="container justify-content-center mb-1">
        <div class="row justify-content-center">
            ...
            <div class="col-md-5">
                <form action="proc_registro.php" method="POST" class="mt-5">
                    <fieldset class="p-5" style="background-color: #2e2a2a; height: 720px;">
                        <div class="form-group">
                            <a href="menu_func.php"><img src="img/setaaa.png" alt="retroceder" style="width: 30px; height: 30px"></a>
                        </div>
                        <div class="form-group mb-5" style="text-align: center; margin-top: -25px">
                            <h1 class="mb-5 mt-5" style="color: #fff">REGISTRAR VEÍCULO</h1>
                        </div>
                        <div class="form-group mb-5">
                            <label class="mb-2" for="veiculo" style="color: #fff; font-family: roboto, sans-serif">Veículo</label>
                            <input type="text" name='veiculo' pattern=".{1,250}" class="form-control" id="veiculo" aria-describedby="emailHelp" placeholder="Veículo" style="font-family: roboto, sans-serif; border-color: #c4c4c4; border-style: solid;" required>
                        </div>
                        <div class="form-group mb-5">
                            <label class="mb-2" for="placa" style="color: #fff; font-family: roboto, sans-serif">Placa</label>
                            <input type="text" name='placa' minlength='7' maxlength='7' class="form-control" id="placa" placeholder="Placa" style="font-family: roboto, sans-serif; border-color: #c4c4c4; border-style: solid;" required>
                        </div>
                        <div class="form-group mb-5">
