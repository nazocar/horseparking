...
<head>
    ...
    <script src="scripttel.js"></script>
    <title>Horse Parking - CADASTRO</title>
</head>
<body style="background-color: #EDEDED">
    ...
    <div class="container justify-content-center mb-1">
        <div class="row justify-content-center">
            ...
            <div class="col-md-5">
                <form action="proc_cad.php" method="POST" class="mt-5">
                    <fieldset class="p-5" style="background-color: #2e2a2a; height: 820px;">
                        ...
                        <div class="form-group mb-5" style="text-align: center; margin-top: -25px">
                            <h1 class="mb-5 mt-5" style="color: #fff">CADASTRAR USUÁRIO</h1>
                        </div>
                        <div class="form-group mb-5">
                            <label class="mb-2" for="username" style="color: #fff; font-family: roboto, sans-serif">Username</label>
                            <input type="text" name="username" pattern=".{1,250}" title="Insira 1 ou mais caracteres" class="form-control" id="username" aria-describedby="emailHelp" placeholder="Username" style="font-family: roboto, sans-serif; border-color: #c4c4c4; border-style: solid;" required>
                        </div>
                        <div class="form-group mb-5">
                            <label class="mb-2" for="email" style="color: #fff; font-family: roboto, sans-serif">E-mail</label>
                            <input type="email" name="email" pattern=".{1,200}" class="form-control" id="email" placeholder="E-mail" style="font-family: roboto, sans-serif; border-color: #c4c4c4; border-style: solid;" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-9 mb-5">
                                    <input type="tel" name="tel" pattern=".{8,}" title="Insira um número válido" class="form-control" id="tel" placeholder="Telefone" maxlength="15" style="font-family: roboto, sans-serif; border-color: #c4c4c4; border-style: solid;" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group mb-5">
                            <label class="mb-2" for="senha" style="color: #fff; font-family: roboto, sans-serif">Senha</label>
                            <input type="password" name="senha" pattern=".{8,100}" title="Insira 8 ou mais caracteres" class="form-control" id="senha" placeholder="Senha" style="font-family: roboto, sans-serif; border-color: #c4c4c4; border-style: solid;" required>
                        </div>
